module.exports=[65081,e=>{"use strict";function i(e){let i=e>>>0;return()=>{i|=0;let e=Math.imul((i=i+0x6d2b79f5|0)^i>>>15,1|i);return(((e=e+Math.imul(e^e>>>7,61|e)^e)^e>>>14)>>>0)/0x100000000}}function t(e){let i=0x811c9dc5;for(let t=0;t<e.length;t++)i^=e.charCodeAt(t),i=Math.imul(i,0x1000193);return i>>>0}let a=(e,i)=>Number(e.toFixed(i));function s(e,a,r,n,o,l=90){let d,c,_=(d=i(t("walk:"+a)),c=(e,i)=>e+d()*(i-e),a.startsWith("common:")?{vol:n?c(.016,.03):c(.01,.018),reversion:.045,trendSlope:c(-.006,.006),seasonalAmp:c(.04,.1),seasonalPeriod:c(40,75),seasonalPhase:d()*Math.PI*2}:{vol:n?c(.03,.05):c(.018,.03),reversion:c(.035,.07),trendSlope:c(-.006,.006),seasonalAmp:c(.03,.09),seasonalPeriod:c(22,60),seasonalPhase:d()*Math.PI*2}),u=i((t("walk:"+a)^(r+1)*0x9e3779b1)>>>0),p=(-_.vol+2*u()*_.vol)*o*3,E=_.seasonalAmp*o*Math.sin(_.seasonalPhase+r/_.seasonalPeriod*Math.PI*2),m=l/2,g=m*Math.tanh((r-m)/m),P=_.trendSlope*o*g;return e+_.reversion*(P+E-e)+p}e.s(["perfSnapshot",0,function(e){let i=new Map,t=e=>{let t=i.get(e);return t||i.set(e,t={sites:0,volume:0,revenue:0,marginPool:0,egPriceVol:0,compPriceVol:0,compVol:0,cheaper:0,inLine:0,dearer:0,cfVolume:0,cfMarginPool:0}),t};for(let i of e){var a,s,r;let e="US"===i.country?.05:.02,n=i.competitors.length>0?i.competitors.reduce((e,i)=>e+i.price,0)/i.competitors.length:i.egPrice,o=i.volume,l=(i.egPrice-i.unitCost)*o,d=i.egPrice-n,c=d<-e?"cheaper":d>e?"dearer":"inLine",_=i.baseEgMargin??Math.max(0,(i.baseEgPrice??i.egPrice)-i.unitCost),u=i.unitCost+_,p=(a=i,s=u,r=n,Math.max(50,(a.baseVolume??a.volume)*(1+a.elasticity*(r>0?(s-r)/r:0)*.4))),E=(u-i.unitCost)*p;for(let e of[i.country,"ALL"]){let a=t(e);a.sites+=1,a.volume+=o,a.revenue+=i.egPrice*o,a.marginPool+=l,a.egPriceVol+=i.egPrice*o,a.compPriceVol+=n*o,a.compVol+=o,a[c]+=1,a.cfVolume+=p,a.cfMarginPool+=E}}let n=[];for(let[e,t]of i)n.push({country:e,sites:t.sites,volume:t.volume,revenue:t.revenue,marginPool:t.marginPool,avgMargin:t.volume>0?t.marginPool/t.volume:0,avgEgPrice:t.volume>0?t.egPriceVol/t.volume:0,avgCompPrice:t.compVol>0?t.compPriceVol/t.compVol:null,cheaper:t.cheaper,inLine:t.inLine,dearer:t.dearer,cfVolume:t.cfVolume,cfMarginPool:t.cfMarginPool});return n},"stepDay",0,function(e,r,n={}){let o=i(r),l=[],d={...n},c=r-1,_=0;if(.07>o()){let e=.5>o(),i=.015+.015*o();_+=e?i:-i,l.push({scope:"network",kind:"crude_spike",headline:e?`Crude firms — wholesale up ${(100*i).toFixed(0)}\xa2 equivalent`:`Crude eases — wholesale down ${(100*i).toFixed(0)}\xa2 equivalent`,detail:e?"A spot-market move pushes wholesale costs up across the network. Expect pump prices to follow within a day or two.":"Spot wholesale costs fall back across the network, loosening cost pressure on pump prices.",tone:e?"bad":"good"})}let u=null;if(.1>o()&&e.length){let i=[...new Set(e.map(e=>e.region))];(u=i[Math.floor(o()*i.length)]??null)&&l.push({scope:"region",ref:u,kind:"price_war",headline:`Price war in ${u}`,detail:"Local competitors are cutting aggressively — rival prices drop and demand becomes more price-sensitive.",tone:"bad"})}let p=null;return .06>o()&&e.length&&(p=e[Math.floor(o()*e.length)]?.siteId??null),{sites:e.map(e=>{let n="US"===e.country,o=n?2:3,E=n?1:.42,m=i((r^t(e.siteId))>>>0),g=(e,i)=>e+m()*(i-e),P="basevol:"+e.siteId,y=e.baseVolume??d[P]??e.volume;d[P]=y;let S="common:"+e.siteId,h=d[S]??0,v=s(h,S,c,n,E);d[S]=v;let $=v-h,D=e.baseUnitCost??e.unitCost,A=e.unitCost+$+_*E+.04*(D-e.unitCost);if(e.siteId===p){let i=g(.04,.09)*E;A+=i,l.push({scope:"site",ref:e.siteId,kind:"outage",headline:"Local supply disruption",detail:"A delivery shortfall lifts this site's wholesale cost sharply for the day.",tone:"bad"})}A=Math.max(.2*E,A);let f=u&&e.region===u,T=e=>{let a,r,o,l=(a=i(t(e)),{commonWeight:(r=(e,i)=>e+a()*(i-e))((o=e.endsWith("|EG"))?.55:.3,.7),fastUp:o?r(.5,.78):r(.42,.85),slowDown:o?r(.12,.22):r(.1,.3)}),_="priv:"+e,u=s(d[_]??0,_,c,n,E);d[_]=u;let p=l.commonWeight*v+(1-l.commonWeight)*u,m="drive:"+e,g=d[m]??p;return d[m]=p,{drive:p,driveDelta:p-g,tr:l}},C=e.competitors.map(s=>{let n=e.siteId+"|"+s.name,l=i((r^t(e.siteId+s.name))>>>0),{driveDelta:d,tr:c}=T(n),_=s.baseMargin??Math.max(.02*E,s.price-A),u=d>0?c.fastUp:c.slowDown,p=s.price-(A+_),m=s.price+u*d+-(p>0?.22:.07)*p;return f&&(m-=(.01+.025*l())*E),m=Math.max(A+.005*E,m),{name:s.name,price:a(m,o),baseMargin:_}}),N=C.length>0?C.reduce((e,i)=>e+i.price,0)/C.length:e.egPrice,L=e.siteId+"|EG",O=e.baseEgMargin??Math.max(.02*E,e.egPrice-A),{driveDelta:R,tr:w}=T(L),b=R>0?w.fastUp:w.slowDown,M=e.egPrice-(A+O),I=e.egPrice+b*R+-(M>0?.22:.07)*M;I=a(I=Math.max(A+.02*E,I),o);let x=N>0?(I-N)/N:0,U=1+e.elasticity*x*(f?1.4:1)*.4,F="vol:"+e.siteId,W=.6*(d[F]??0)+g(-.018,.018);d[F]=W;let H=y*U*(1+W);if(H=Math.max(50,Math.round(H)),.03>m()){let i=g(-.18,.2);H=Math.max(50,Math.round(H*(1+i))),Math.abs(i)>.12&&l.push({scope:"site",ref:e.siteId,kind:"demand_swing",headline:i>0?"Demand surge":"Demand dip",detail:`Footfall ${i>0?"rose":"fell"} ~${Math.abs(Math.round(100*i))}% at this site today.`,tone:i>0?"good":"bad"})}return{...e,unitCost:a(A,o+1),egPrice:I,competitors:C,volume:H,baseVolume:y}}),events:l,crudeDelta:_,signal:d}}])},72874,e=>e.a(async(i,t)=>{try{var a=e.i(45095),s=e.i(69473),r=e.i(65081),n=i([a]);[a]=n.then?(await n)():n;let D=e=>e instanceof Date?new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate())).toISOString().slice(0,10):String(e).slice(0,10);function o(e,i){let[t,a,s]=e.split("-").map(Number),r=new Date(Date.UTC(t,a-1,s));return r.setUTCDate(r.getUTCDate()+i),r.toISOString().slice(0,10)}function l(e){let i=D(e.sim_date),t=Number(e.day_index);return{simDate:i,dayIndex:t,running:!!e.running,speedMs:Number(e.speed_ms),baselineDate:o(i,-t)}}async function d(){let e=await (0,a.pgQuery)(`SELECT sim_date, day_index, running, speed_ms FROM ${(0,s.APP)("sim_state")} WHERE id = 1`);if(!e.length){let e=await (0,a.pgQuery)(`SELECT COALESCE(max(day), CURRENT_DATE) AS d FROM ${(0,s.APP)("price_history")}`),i=D(e[0]?.d??new Date);return{simDate:i,dayIndex:0,running:!1,speedMs:3e3,baselineDate:i}}return l(e[0])}async function c(){let e=(await (0,a.pgQuery)(`SELECT count(*)::int AS days,
      ...
      LIMIT $1`,[e])).map(e=>({id:Number(e.id),day:D(e.day),dayIndex:Number(e.day_index),scope:e.scope,ref:e.ref??void 0,kind:e.kind,headline:e.headline,detail:e.detail??void 0,tone:e.tone}))}async function u(e,i){let t=await e(`WITH reg_cost AS (
     ...
     SELECT cp.site_id, cp.competitor_name AS name,
      ...
      WHERE cp.grade_id = 'regular'`,[i]),r=new Map;for(let e of t)null!=e.base_cost?r.set(e.site_id,Number(e.base_cost)):null!=e.unit_cost&&r.set(e.site_id,Number(e.unit_cost));let n=new Map;for(let e of a){let i=e.site_id,t=n.get(i)??[],a=r.get(i),s=null==e.base_price?null:Number(e.base_price),o=null!=s&&null!=a?s-a:void 0;t.push({name:e.name,price:Number(e.price),baseMargin:o}),n.set(i,t)}return t.filter(e=>null!=e.unit_cost&&null!=e.eg_price).map(e=>{let i=Number(e.unit_cost),t=null==e.base_cost?i:Number(e.base_cost),a=null==e.base_eg_price?Number(e.eg_price):Number(e.base_eg_price);return{siteId:e.site_id,region:e.region,country:e.country,unitCost:i,baseUnitCost:t,egPrice:Number(e.eg_price),baseEgMargin:a-t,baseEgPrice:a,volume:null==e.avg_daily_volume?1500:Number(e.avg_daily_volume),baseVolume:null!=e.base_avg_daily_volume?Number(e.base_avg_daily_volume):null==e.avg_daily_volume?1500:Number(e.avg_daily_volume),elasticity:null==e.elasticity?-1.4:Number(e.elasticity),competitors:n.get(e.site_id)??[]}})}async function p(e,i,t,a,n){{let t=[],r=[],n=0,o=(e,a,s,o)=>{t.push(`($${++n},'regular',$${++n},$${++n},$${++n},$${++n})`),r.push(e,a,s,i,o)};for(let e of a){for(let i of(o(e.siteId,"EG",!0,e.egPrice),e.competitors))o(e.siteId,i.name,!1,i.price);o(e.siteId,s.COST_SERIES,!1,e.unitCost)}for(let i=0;i<t.length;i+=1e3){let a=t.slice(i,i+1e3),n=r.slice(5*i,(i+a.length)*5),o=0,l=a.map(()=>`($${++o},'regular',$${++o},$${++o},$${++o},$${++o})`).join(",");await e(`INSERT INTO ${(0,s.APP)("price_history")} (site_id, grade_id, series, is_eg, day, price)
       ...
       VALUES ${a.join(",")}`,r)}}async function E(e,i){let t=await e(`SELECT day_index, levels FROM ${(0,s.APP)("sim_signal_state")} WHERE id = 1`);if(!t.length||Number(t[0].day_index)!==i)return{};let a=t[0].levels;return"string"==typeof a?JSON.parse(a):a}async function m(e,i,t){await e(`INSERT INTO ${(0,s.APP)("sim_signal_state")} (id, day_index, levels, updated_at)
     VALUES (1, $1, $2::jsonb, now())
     ON CONFLICT (id) DO UPDATE SET day_index = EXCLUDED.day_index,
                                    levels = EXCLUDED.levels,
                                    updated_at = now()`,[i,JSON.stringify(t)])}async function g(e,i,t){let a=o(i.simDate,-i.dayIndex),n=await u(e,a),l=i.simDate,d=i.dayIndex,c=await E(e,d);for(let i=0;i<t;i++){l=o(l,1),d+=1;let{sites:i,events:t,signal:a}=(0,r.stepDay)(n,d+1,c);await p(e,l,d,i,t),n=i,c=a}return await m(e,d,c),await e(`INSERT INTO ${(0,s.APP)("sim_state")} (id, sim_date, day_index, updated_at)
     VALUES (1, $1, $2, now())
     ON CONFLICT (id) DO UPDATE SET sim_date = EXCLUDED.sim_date,
                                    day_index = EXCLUDED.day_index,
                                    updated_at = now()`,[l,d]),{...i,simDate:l,dayIndex:d}}async function P(e){let i=await e(`SELECT sim_date, day_index, running, speed_ms FROM ${(0,s.APP)("sim_state")} WHERE id = 1 FOR UPDATE`),t=new Date().toISOString().slice(0,10);return i.length?l(i[0]):{simDate:t,dayIndex:0,running:!1,speedMs:3e3,baselineDate:t}}async function y(e=1){return(0,a.pgTransaction)(async i=>{await i("SELECT pg_advisory_xact_lock($1)",[918273]);let t=await P(i);return g(i,t,e)})}async function S(){return(0,a.pgTransaction)(async e=>{await e("SELECT pg_advisory_xact_lock($1)",[918273]);let i=await e(`SELECT sim_date, day_index, running, speed_ms,
              (next_advance_at IS NULL OR now() >= next_advance_at) AS due
         FROM ${(0,s.APP)("sim_state")} WHERE id = 1 FOR UPDATE`);if(!i.length)return{state:await $(e),stepped:!1};let t=l(i[0]),a=!!i[0].due;if(!t.running||!a)return{state:t,stepped:!1};let r=await g(e,t,1);return await e(`UPDATE ${(0,s.APP)("sim_state")}
          SET next_advance_at =
                GREATEST(now(), COALESCE(next_advance_at, now()))
                + (speed_ms * interval '1 millisecond')
        WHERE id = 1`),{state:r,stepped:!0}})}async function h(e){return(0,a.pgTransaction)(async i=>{await i("SELECT pg_advisory_xact_lock($1)",[918273]);let t=await i(`SELECT running, speed_ms FROM ${(0,s.APP)("sim_state")} WHERE id = 1 FOR UPDATE`),a=!!t.length&&!!t[0].running,r=t.length?Number(t[0].speed_ms):3e3,n=[],o=[],l=0;null!=e.running&&(n.push(`running = $${++l}`),o.push(e.running));let d=null!=e.speedMs?Math.max(500,Math.min(6e5,Math.round(e.speedMs))):r;return null!=e.speedMs&&(n.push(`speed_ms = $${++l}`),o.push(d)),(null!=e.running?e.running:a)?(!0!==e.running||a)&&null==e.speedMs||(n.push(`next_advance_at = now() + ($${++l} * interval '1 millisecond')`),o.push(d)):n.push("next_advance_at = NULL"),n.length&&(n.push("updated_at = now()"),await i(`UPDATE ${(0,s.APP)("sim_state")} SET ${n.join(", ")} WHERE id = 1`,o)),$(i)})}async function v(){return(0,a.pgTransaction)(async e=>{await e("SELECT pg_advisory_xact_lock($1)",[918273]);let i=await e(`SELECT sim_date, day_index FROM ${(0,s.APP)("sim_state")} WHERE id = 1 FOR UPDATE`);if(i.length){let t=Number(i[0].day_index),a=o(D(i[0].sim_date),-t);await e(`DELETE FROM ${(0,s.APP)("price_history")} WHERE day > $1`,[a]),await e(`DELETE FROM ${(0,s.APP)("sim_events")}`),await e(`DELETE FROM ${(0,s.APP)("sim_daily_perf")}`),await e(`DELETE FROM ${(0,s.APP)("sim_interventions")}`),await e(`DELETE FROM ${(0,s.APP)("price_recommendations")}
          ...
          WHERE id = 1`,[a])}return $(e)})}async function $(e){let i=await e(`SELECT sim_date, day_index, running, speed_ms FROM ${(0,s.APP)("sim_state")} WHERE id = 1`);return l(i[0])}e.s(["applyStep",0,y,"getPerfSummary",0,c,"getSimEvents",0,_,"getSimState",0,d,"resetSim",0,v,"setSimFlags",0,h,"tickIfDue",0,S]),t()}catch(e){t(e)}},!1)];
